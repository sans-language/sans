...
const HOVER_DATA: Record<string, string> = {
    ...
    'bxor': '**bxor**(a: Int, b: Int) -> Int\n\nBitwise XOR. Native LLVM i64 operation.\n\nUsage: `x = bxor(0xFF 0x0F)`',
    'band': '**band**(a: Int, b: Int) -> Int\n\nBitwise AND. Native LLVM i64 operation.\n\nUsage: `mask = band(val 0xFF)`',
    'bor': '**bor**(a: Int, b: Int) -> Int\n\nBitwise OR. Native LLVM i64 operation.\n\nUsage: `flags = bor(a b)`',
    'bshl': '**bshl**(a: Int, b: Int) -> Int\n\nBitwise shift left. Native LLVM i64 operation.\n\nUsage: `shifted = bshl(1 8)`',
    'bshr': '**bshr**(a: Int, b: Int) -> Int\n\nBitwise shift right. Native LLVM i64 operation.\n\nUsage: `high = bshr(val 32)`',
