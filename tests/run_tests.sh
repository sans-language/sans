...
run_negative_test "neg_undefined_struct"    "$REPO_ROOT/tests/negative/undefined_struct.sans"       "undefined"
run_negative_test "neg_wrong_field_init"    "$REPO_ROOT/tests/negative/wrong_field_init.sans"       "undefined"
