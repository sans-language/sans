...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-typeck check_json 2>&1 | tail -20`
...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-typeck check_json 2>&1 | tail -30`
...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-typeck 2>&1 | tail -5`
...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-ir lower_json 2>&1 | tail -20`
...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-ir 2>&1 | tail -5`
...
Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo build -p sans-codegen 2>&1 | tail -10`
Expected: Compiles successfully

- [ ] **Step 4: Run all existing codegen tests (should still pass)**

Run: `cd /Users/sgordon/Development/Repos/cyflym && LLVM_SYS_170_PREFIX=$(brew --prefix llvm@17) cargo test -p sans-codegen 2>&1 | tail -5`
...
```bash
git add tests/fixtures/json_object_stringify.cy tests/fixtures/json_int_roundtrip.cy tests/fixtures/json_build.cy tests/fixtures/json_parse_access.cy tests/fixtures/json_roundtrip.cy crates/sans-driver/tests/e2e.rs
