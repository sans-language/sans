...
tnow()            time_now()            -> I (unix timestamp, alias for time())
tfmt(t fmt)       time_format(t fmt)    I S -> S (strftime pattern)
tyear(t)          time_year(t)          I -> I (year e.g. 2026)
tmon(t)           time_month(t)         I -> I (month 1-12)
tday(t)           time_day(t)           I -> I (day 1-31)
thour(t)          time_hour(t)          I -> I (hour 0-23)
tmin(t)           time_minute(t)        I -> I (minute 0-59)
tsec(t)           time_second(t)        I -> I (second 0-59)
twday(t)          time_weekday(t)       I -> I (weekday 0=Sun..6=Sat)
tadd(t n)         time_add(t n)        I I -> I (add seconds)
tdiff(a b)        time_diff(a b)       I I -> I (a - b in seconds)
...
slen(p)                                 I -> I (strlen, byte length — use char_count() for UTF-8)
...
// Unicode / UTF-8 (strings are byte arrays; these interpret as UTF-8)
char_count(s) / ccount(s)               S -> I (count UTF-8 codepoints)
chars(s)                                 S -> Array<S> (split into UTF-8 chars)
is_ascii(s)                              S -> I (1 if all bytes < 128)
utf8_valid(s)                            S -> I (1 if valid UTF-8)
string_reverse(s) / srev(s)             S -> S (UTF-8 aware reverse)
